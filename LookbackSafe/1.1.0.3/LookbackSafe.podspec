Pod::Spec.new do |s|
  s.name = "LookbackSafe"
  s.version = "1.1.0.3"
  s.summary = "THIS IS A BETA VERSION. Records screen, camera, touches and uploads to lookback.io. Useful for research, video bug reports, …. Can be used in AppStore apps."
