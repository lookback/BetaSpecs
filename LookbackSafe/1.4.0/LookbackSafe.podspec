...
DESCRIPTION
  ...
  s.documentation_url = "https://s3-eu-west-1.amazonaws.com/lookback-public/docs/ios/1.4.0.184.g54ab93a/Lookback_h/index.html"
  s.source = {
    :http => "https://s3-eu-west-1.amazonaws.com/lookback-public/sdk/lookback-sdk-1.4.0.184.g54ab93a.zip"
  }
  ...
  s.preserve_paths = ["lookback/LICENSE.md", "lookback/Safe/Lookback.framework"]
  s.frameworks = [
    "Accelerate",
    "AVFoundation",
    "AudioToolbox",
