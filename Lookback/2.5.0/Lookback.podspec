...
DESCRIPTION
  ...
  s.source = {
    :http => "https://s3-eu-west-1.amazonaws.com/lookback-public/sdk/lookback-sdk-2.5.0.10.gd22f63e.zip"
  }
  s.documentation_url = "https://s3-eu-west-1.amazonaws.com/lookback-public/docs/ios/2.5.0.10.gd22f63e/Lookback_h/index.html"
  s.platforms = {
    :ios => "8.0"
  }
  s.xcconfig = {
